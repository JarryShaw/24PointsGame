...
class Tkinter_Game():
    ...
    def poker_1st(self):
        ...
        self.number_order[self.number_counter] = '1'
        self.state_refresh(self.root_window)
    ...
    def poker_2nd(self):
        ...
        #print self.state
        self.number_counter += 1
        self.number_order[self.number_counter] = '2'
        self.state_refresh(self.root_window)
        #self.board_button_poker1st.config(state='disabled')
    ...
    def poker_3rd(self):
        ...
        #print self.state
        self.number_counter += 1
        self.number_order[self.number_counter] = '3'
        self.state_refresh(self.root_window)
        #self.board_button_poker1st.config(state='disabled')
    ...
    def poker_4th(self):
        ...
        #print self.state
        self.number_counter += 1
        self.number_order[self.number_counter] = '4'
        self.state_refresh(self.root_window)
        #self.board_button_poker1st.config(state='disabled')
    ...
    def delete_button_counter(self):
        ...
        self.state_string = self.state_string[:-1]
    ...
    def bracketRight_button_active(self):
