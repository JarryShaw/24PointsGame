...
class Game:
    ...
    def get_problem(self):
        self.problem[0] = int(raw_input('第一個數字為：'))
        self.problem[1] = int(raw_input('第二個數字為：'))
        self.problem[2] = int(raw_input('第三個數字為：'))
        self.problem[3] = int(raw_input('第四個數字為：'))

    #判斷輸入答案是否正確
    def check_answer(self, answer): 
        try:
            rst = eval(answer)
            if rst == 24:   print 'Yeh!';  return 1
            else        :   print 'Nah!';   return 0
        except:
            return 0
